...
describe('Text', () => {
  it('Visits the app root url', () => {
    cy.visit('http://127.0.0.1:8080/notfound')
    cy.contains('h2', '404')
    cy.contains('h3', 'Page not found')
  })
})
...
context('Location', () => {
  ...
  it('cy.location() - get window.location', () => {
    ...
    cy.location().should((location) => {
      ...
      expect(location.href).to.eq('http://127.0.0.1:8080/notfound')
  ...
  it('cy.url() - get the current URL', () => {
    ...
    cy.url().should('eq', 'http://127.0.0.1:8080/notfound')
  })
})
