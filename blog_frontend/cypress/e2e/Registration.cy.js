...
context('Actions', () => {
  ...
  it('.type() - type into a DOM element', () => {
    ...
    cy.get('.registration-bio')
      .type('fakebio').should('have.value', 'fakebio')
      ...
      // Delay each keypress by 0.1 sec
      .type('slowtypingbio', { delay: 100 })
      .should('have.value', 'slowtypingbio') 


    cy.get('.registration-birthdate')
  ...
  it('.submit() - submit a form', () => {
    ...
    cy.get('.register-form')
      ...
      cy.get('.register-form')
      .find('[type="bio"]').type('aosdijaosdja')
...
context('Location', () => {
  ...
  it('cy.location() - get window.location', () => {
    ...
    cy.location().should((location) => {
      ...
      expect(location.href).to.eq('http://127.0.0.1:8080/registration')
  ...
  it('cy.url() - get the current URL', () => {
    ...
    cy.url().should('eq', 'http://127.0.0.1:8080/registration')
  })
})
